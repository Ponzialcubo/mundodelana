...
export function AuthTabs() {
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col gap-6 px-5 py-14 md:px-0">
      ...
      {/* eslint-disable-next-line @next/next/no-html-link-for-pages -- API route, not an app page */}
      <a
        href="/api/auth/signin/google?callbackUrl=/cuenta"
        className="flex items-center justify-center gap-2.5 rounded-full border border-ink/16 bg-white px-6 py-3 text-sm font-medium text-ink"
      >
